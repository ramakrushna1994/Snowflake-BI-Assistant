...
INSERT INTO SALES_CHANNELS (CHANNEL_NAME, CHANNEL_TYPE) VALUES
('Website', 'Online'), ('Mobile App', 'Online'), ('In-Store', 'Retail'),
('Distributor', 'Wholesale'), ('Partner Portal', 'Partner');
...
-- ── PRODUCTS (recreate with 100 rows) ─────────────────────
...
-- ── CUSTOMERS (recreate with 500 rows via GENERATOR) ──────
...
SELECT
    ...
    ROUND(UNIFORM(25,2200,RANDOM())::DECIMAL(12,2),2) AS TOTAL_AMOUNT,
...
SELECT
    ...
    ROUND(UNIFORM(10,5000,RANDOM())::DECIMAL(12,2),2) AS LINE_TOTAL
