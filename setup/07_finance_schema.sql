...
SELECT
    ...
    DATEADD(DAY, UNIFORM(15,60,RANDOM()), DATEADD(DAY,-UNIFORM(0,730,RANDOM()),CURRENT_DATE())) AS DUE_DATE,
    ROUND(UNIFORM(100,10000,RANDOM())::DECIMAL(12,2),2) AS INVOICE_AMOUNT,
    ROUND(UNIFORM(8,800,RANDOM())::DECIMAL(10,2),2)    AS TAX_AMOUNT,
    ROUND(UNIFORM(108,10800,RANDOM())::DECIMAL(12,2),2) AS TOTAL_DUE,
    ROUND(IFF(UNIFORM(1,5,RANDOM())<4, UNIFORM(108,10800,RANDOM()), 0)::DECIMAL(12,2),2) AS PAID_AMOUNT,
    ...
    IFF(UNIFORM(1,5,RANDOM())<4, DATEADD(DAY,UNIFORM(1,45,RANDOM()),DATEADD(DAY,-UNIFORM(0,730,RANDOM()),CURRENT_DATE())), NULL) AS PAYMENT_DATE
...
SELECT
    ...
    ROUND(UNIFORM(10,15000,RANDOM())::DECIMAL(12,2),2) AS LINE_AMOUNT,
